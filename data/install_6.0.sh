...
get_node_url(){
	...
	btpanel_Url=http://download.btpanel.net
...
Install_Bt(){
	...
	wget -O /www/server/panel/install/public.sh ${btpanel_Url}/install/public.sh -T 10
    ...
    chattr +i /www/server/panel/install/public.sh
	wget -O /www/server/panel/install/check.sh ${btpanel_Url}/install/check.sh -T 10
	chattr +i /www/server/panel/install/check.sh
	rm -f panel.zip
